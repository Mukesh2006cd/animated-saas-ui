...
function Card({mukesh, buttontext="mat kar click"})  {

    // the props are needed to be written inside the {} brackets or they wont work
// we have also made a default value for buttontext if some one forgot to put buttontext inside the <Card /> as a props
    console.log(mukesh)
    return(<div class="w-full max-w-xs overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg shadow-slate-950/5">
